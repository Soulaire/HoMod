package soulaire.homod.world.gen.generators;
...
public class WorldGenHomiumTree2 extends WorldGenAbstractTree 
{
	public static final IBlockState LOG = BlockInit.LOG.getDefaultState().withProperty(BlockLogs.VARIANT, EnumHandler.EnumType.HOMIUM);
	public static final IBlockState LEAF = BlockInit.LEAVES.getDefaultState().withProperty(BlockLogs.VARIANT, EnumHandler.EnumType.HOMIUM);
	
	private final int minHeight;
	
	public WorldGenHomiumTree2() 
	{
		super(false);
		this.minHeight = 12;
	}
